    ...
    const createSchema = (type: z.ZodType, key: string) =>
        ...
        const res = z
            .object({
                ...
                created: createSchema(z.string().refine((arg) => new Date(arg).toString() !== 'Invalid Date'), 'created'),
                updated: createSchema(z.string().refine((arg) => new Date(arg).toString() !== 'Invalid Date'), 'updated'),
